                ...
                <table>
                    ...
                    <tbody>
                        @foreach ($blogs as $blog)
                            <tr>
                                <td class="text-center align-middle p-4">{{ $blog->titulo }}</td>
                                <td class="text-center align-middle p-4">{{ $blog->descripcion }}</td>
                                <td class="text-center align-middle p-4"><a href=" {{ route('blogs.blogContenido', ['id' => $blog->blog_id]) }} " class="btn-action">Ver contenido</a></td>
                                <td class="text-center align-middle p-4 font-italic">{{ $blog->autor }}</td>
