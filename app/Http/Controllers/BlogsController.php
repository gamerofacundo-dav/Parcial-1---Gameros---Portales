...
class BlogsController extends Controller {
    ...
    public function store(Request $request) {
      ...
      $data = $request->only('titulo', 'descripcion', 'contenido');
      $data['contenido'] = $contenidoLimpio;
      $data['autor'] = Auth::user()->name ?? 'Administrador';

      Blog::create($data);

      return to_route('blogs.adminBlogs')->with('feedback.message', 'El blog <b>' . e($data['titulo']) . '</b> se creó con éxito.');
    }   
    ...
    public function update(Request $request, int $id) {
      ...
      return to_route('blogs.adminBlogs')->with('feedback.message', 'El blog <b>' . e($data['titulo']) . '</b> se editó con éxito.'); 
    }
